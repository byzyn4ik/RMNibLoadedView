...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of RMNibLoadedView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/RMNibLoadedView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Maks Petrovsky' => 'petrovskiy@real.me' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/RMNibLoadedView.git', :tag => s.version.to_s }
